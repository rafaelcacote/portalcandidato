        ...
        >
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">
                    Confira os grupos e itens do edital. Envie os comprovantes
                    na etapa de documentos obrigatórios.
                </p>
            </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <span v-if="item.period_rule"
                                    >Regra: {{ item.period_rule }}</span
                                >
                                <span>
                                    Formatos:
                                    {{ formatsLabel(item.accepted_formats) }} ·
        ...
        <Card v-else class="rounded-xl shadow-sm">
            ...
            <template #subtitle>
                <span class="text-sm font-normal text-muted-foreground">
                    Itens configurados pelo edital — organize comprovantes antes
                    do envio.
                </span>
            </template>
            <template #content>
