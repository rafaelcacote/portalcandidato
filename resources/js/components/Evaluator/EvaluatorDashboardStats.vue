...
const completionRate = computed(() => {
    ...
    return Math.round((props.stats.analysis_completed / props.stats.candidates_total) * 100);
});
...
<template>
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div
            ...
            :class="card.highlight ? 'ring-amber-300/60 hover:ring-amber-400/60' : 'ring-slate-200/60 hover:ring-slate-300/60'"
        >
            <!-- Top row -->
