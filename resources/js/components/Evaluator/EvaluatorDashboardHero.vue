        ...
        <div class="relative z-10 grid gap-5 px-5 py-6 md:grid-cols-12 md:gap-6 md:px-8 md:py-8">
            ...
            <div class="md:col-span-7 lg:col-span-7">
                ...
                <p class="mt-3 max-w-md text-sm leading-relaxed text-slate-600 [text-shadow:0_0_18px_rgba(255,255,255,0.8)]">
                    Gerencie as análises de candidatos, valide documentos e registre pontuações dos
                ...
                <div class="mt-5 flex flex-wrap items-center gap-2">
                    ...
                    >
                        ...
                        {{ processesTotal === 1 ? '1 processo atribuído' : `${processesTotal} processos atribuídos` }}
                    </span>
                    <span
                    ...
                    >
                        <Clock class="size-3" />
                        {{ pendingAnalysis }} {{ pendingAnalysis === 1 ? 'análise pendente' : 'análises pendentes' }}
                    </span>
                    <span
                        v-else
                        class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200/80 bg-white/80 px-3 py-1.5 text-xs font-medium text-slate-600 shadow-sm backdrop-blur-sm"
            ...
            <div class="flex md:col-span-5 lg:col-span-5 md:justify-end">
                ...
                >
                    ...
                    <div class="flex items-start justify-between gap-2">
                        ...
                        >
                            {{ highlightProcess.pending_candidates }} pendente{{ highlightProcess.pending_candidates !== 1 ? 's' : '' }}
                        </span>
                    </div>
                    ...
                    <!-- CTA button -->
                    <Link :href="processShow({ selectionProcess: highlightProcess.id }).url" class="mt-0.5">
                        <button
                            type="button"
                ...
                >
                    <p class="text-sm font-semibold text-slate-600">Nenhuma análise pendente</p>
