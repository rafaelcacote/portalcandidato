        ...
        <div class="mx-auto flex w-full max-w-[1820px] flex-col gap-5">
            ...
            <div v-else class="flex flex-col gap-3">
                ...
                >
                    <template #content>
                        ...
                        >
                            ...
                            <div class="flex min-w-0 items-start gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    >
                                        <span
                                            v-if="application.numero_protocolo"
                            ...
                            <div class="flex shrink-0 items-center gap-2">
                                ...
                                <Tag
                                    ...
                                    "
                                    :severity="
                                        statusSeverity[application.status] ??
                                        'secondary'
                                    "
                                />
                                <Link
                        ...
                        <div
                            v-if="application.status === 'pendencia'"
                            class="mt-4 flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-900 dark:bg-amber-950/30"
                        >
                            <i
                            ...
                            >
                                Esta inscrição possui pendências. Acesse para
                                ver detalhes.
                            </p>
                        </div>

                        <div
                            v-if="application.status === 'reprovada'"
                            class="mt-4 flex items-center gap-2 rounded-lg border border-red-200 bg-red-50 px-3 py-2 dark:border-red-950/30 dark:bg-red-950/30"
                        >
            ...
            >
                <span class="text-sm text-muted-foreground">
                    Exibindo página {{ applications.current_page }} de
