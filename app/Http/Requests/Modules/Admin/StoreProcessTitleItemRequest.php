...
class StoreProcessTitleItemRequest extends FormRequest
{
    ...
    {
        return [
            'code.required' => 'Informe o código do item (ex.: A.1, B.2).',
            ...
            'score_unit.required' => 'Informe a unidade de pontuação (ex.: por título, por ano).',
        ];
    }
}
